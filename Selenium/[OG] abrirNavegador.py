...
options.add_argument(r"--user-data-dir=C:\Users\CAMBIA3\AppData\Local\Google\Chrome\User Data - Selenium")
...
if quantidade_elementos_auth > 0:
    ...
    driver.find_element("xpath","(//input[@placeholder='Enter code'])[1]").send_keys(auth)
    # Envia um comando de clique para a caixa "NEXT"
    driver.find_element("xpath","(//button[@type='submit'])[1]").click()
else:
